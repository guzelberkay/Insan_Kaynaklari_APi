...
public interface CompanyRepository extends JpaRepository<Company, Long> {
    @Query("select new org.takim2.insan_kaynaklari_api.Vw.PassiveCompaniesView (c.id,c.companyManager.user.id,c.companyName,c.numberOfEmployees,c.subscriptionPlan) from Company  c where c.isActive=?1")
